...
In EF Core, this is modeled by using **navigation properties** and establishing relationships between two entities. The relationship is reflected in how the entities are **linked** by primary and foreign keys.
